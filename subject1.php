...
if (isset($_POST['save'])) {
	...
	$query = "INSERT INTO ieti_db.subject1 (student_id, first_name, last_name, grade) VALUES ('$studentid', '$firstname', '$lastname', '$grade')"; //hit
	...
	mysqli_query($db, "UPDATE ieti_db.subject1 SET prelim='$prelim', midterm='$midterm', final='$final' WHERE student_id = $studentid"); //hit
	...
	mysqli_query($db, "DELETE FROM ieti_db.subject1 WHERE student_id = $studentid"); //hit
	...
	$rec = mysqli_query($db, "SELECT * FROM ieti_db.subject1 WHERE student_id=$studentid");	 //hit
...
<!-- cut to fetch.php (part 1) -->	
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a class = "edit_btn" href="subject1.php?edit=<?php echo $row['student_id']; ?>">Edit</a> <!-- hit -->
			</td>
