...
<br>
			...
			<td>
				<a class = "edit_btn" href="studentfolder.php?editz=<?php echo $_GET['editz']; ?>">Registrar</a>
			</td>
			<br>
			<td>
				<a class = "edit_btn" href="studentfolder2.php?editz=<?php echo $_GET['editz']; ?>">Finance</a>
			</td>
