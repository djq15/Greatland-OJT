...
$output = '';
	...
	*/
	...
	book_code LIKE '%".$search."%' or title LIKE '%".$search."%' or author LIKE '%".$search."%' or category LIKE '%".$search."%' or description LIKE '%".$search."%' 
	";
	}
...
if(mysqli_num_rows($result) > 0)
{
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		$output .= '
			...
			<td>
				<a class = "edit_btn" href="bookprofile.php?edit='.$row["book_code"].'">Edit</a>
			</td>
			
			<td>
				<a href="folderlibrary.php?editzz='.$row["book_code"].'"><img src="settings.jpg"></a> 
