...
$output = '';
	...
	$results = "SELECT * FROM masterlist WHERE Status = 'Active'";
	...
	*/
	$results .= "
	SELECT * FROM masterlist WHERE Status = 'Active' and 
	(First_name LIKE '%".$search."%' or Last_name LIKE '%".$search."%' or Student_No LIKE '%".$search."%' 
	or Middle_initial LIKE '%".$search."%' or Gender LIKE '".$search."%' or Date_of_birth LIKE '%".$search."%' or Age LIKE '%".$search."%' or Street LIKE '%".$search."%' or Province LIKE '%".$search."%' or Home_contact_No LIKE '%".$search."%' 
	or Mobile_No LIKE '%".$search."%' or LRN LIKE '%".$search."%' or Fathers_name LIKE '%".$search."%' or Fathers_contact_No LIKE '%".$search."%' or Fathers_email LIKE '%".$search."%' or Mothers_name LIKE '%".$search."%' or Mothers_contact_No LIKE '%".$search."%' or Mothers_email LIKE '%".$search."%'
