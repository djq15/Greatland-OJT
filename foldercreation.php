...
<?php
	...
	$res = mysqli_query($db, "SELECT * FROM greatland_db.masterlist WHERE Student_No = '$studentno'");
	...
	//$studentno = $recordx['Student_No']; // care
	//$Dir = "uploads/dex/".$_POST["lastname"]."/".$firstname;
	//$Dir = "uploads/dex/".$_POST["lastname"]."-".$firstname;
...
$res = mysqli_query($db, "Update greatland_db.masterlist SET existing_folder = 'N' WHERE Student_No = '$studentno'");
