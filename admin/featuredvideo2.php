	...
	//if (in_array($fileActualExt, $allowed )) {
		...
		rmdir($dir);
			//if ($fileSize < 100000000) {
				...
				//$fileDestination = $file_attach.$fileName;
				//$fileDestination = $file_attach.'VID1.mp4'; return
			...
			$studentno = "6";
			$db = mysqli_connect('localhost', 'root', 'ieti19', 'birthright_db');
			//mysqli_query($db, "UPDATE birthright_db.announcement SET line2='dashvideo/".$tag."' WHERE number = '$studentno'"); //hit return
			mysqli_query($db, "UPDATE birthright_db.announcement SET line2='dashvideo/".$fileNameNew."' WHERE number = '$studentno'"); //hit
			//}
			//else {
