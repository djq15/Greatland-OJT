...
<form method = "post" action = ""> 
	...
	<button type = "submit" name = "update" class = "btn">Remove Video</button>
...
while($file = readdir($dir))
{
	...
	echo "<a href='../dashvideo/$file'>$file</a><a href='featuredvideodelete.php?dir=$file'><img src='delete.png'></a><br>";
