...
if (isset($_POST['submit'])) {
	...
	//$file_attach = "Dexer/";
	//$file_attach = "/";
	$file_attach = "uploadslibrary/".$bookcode."/pic/";
	...
	//if (in_array($fileActualExt, $allowed )) {
		if ($fileError === 0) {
			...
			mysqli_query($db, "UPDATE greatland_db.library SET pic='uploadslibrary/".$bookcode."/pic/".$fileNameNew."' WHERE book_code = '$bookcode'"); //hit
