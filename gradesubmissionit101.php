...
if (isset($_POST['save'])) {
	...
	mysqli_query($db, "UPDATE ieti_db.it101 SET prelim='$prelim', midterm='$midterm', final='$final' WHERE student_id = $studentid"); //hit
	...
	mysqli_query($db, "DELETE FROM ieti_db.it101 WHERE student_id = $studentid"); //hit
	...
	$rec = mysqli_query($db, "SELECT * FROM ieti_db.it101 WHERE student_id=$studentid");	 //hit
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a class = "edit_btn" href="gradesubmissionit101.php?edit=<?php echo $row['student_id']; ?>">Edit</a> <!-- hit -->
			</td>
