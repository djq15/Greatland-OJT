...
<?php
	...
	$rec = mysqli_query($db, "SELECT * FROM greatland_db.masterlist WHERE Student_No='$Student_No'");	
...
$path = "uploads/dex/".$studentno."/files";
...
while($file = readdir($dir))
{
	...
	echo "<a href='uploads/dex/$studentno/files/$file'>$file</a><a href='delete.php?dir=$file&path=$path&studentno=$studentno'><img src='delete.png'></a><br>";
